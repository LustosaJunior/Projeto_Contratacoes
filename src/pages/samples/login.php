<?php
    ...
    if(isset($_SESSION["UserInvalido"]) and $_SESSION["UserInvalido"] == true){
        echo "<script>alert('Usuário inválido!')</script>";

        $_SESSION["UserInvalido"] = false;
    }
?>
          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auto-form-wrapper">
                <form action="verificaUsers.html" method="POST">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary submit-btn btn-block" onclick="return ValidaCampos()">Login</button>
                  </div>
